...
$barangay = isset($_GET['barangay']) ? htmlspecialchars($_GET['barangay']) : "camagong";
?>
<!DOCTYPE html>
<html lang="ceb">
<head>
...
<div class="container">
    ...
    <h2>Barangay Camagong, Nasipit, Agusan del Norte</h2>
    ...
    <section>
        ...
        <div class="checkbox-group">
            ...
            <label><input type="checkbox" name="district[]" value="District 3 Makasehi"> District 3 Makasehi</label>
            <label><input type="checkbox" name="district[]" value="District 4 Kalugmaan"> District 4 Kalugmaan</label>
            <label><input type="checkbox" name="district[]" value="District 5 Mahubo"> District 5 Mahubo</label>
            <label><input type="checkbox" name="district[]" value="District 6"> District 6</label>
            <label><input type="checkbox" name="district[]" value="District 7 Isla Berde"> District 7 Isla Berde</label>
            <label><input type="checkbox" name="district[]" value="District 8 Minbahandi"> District 8 Minbahandi</label>
            <label><input type="checkbox" name="district[]" value="District 9 Hinandayan"> District 9 Hinandayan</label>
        </div>
    </section>
