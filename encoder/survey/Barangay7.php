...
$barangay = isset($_GET['barangay']) ? htmlspecialchars($_GET['barangay']) : "barangay7";
?>
<!DOCTYPE html>
<html lang="ceb">
<head>
...
<div class="container">
    ...
    <h2>Barangay 7, Nasipit, Agusan del Norte</h2>
    ...
    <section>
        ...
        <div class="checkbox-group">
            <label><input type="checkbox" name="district[]" value="Calachuchi"> Calachuchi</label>
            <label><input type="checkbox" name="district[]" value="Sampaguita"> Sampaguita</label>
            <label><input type="checkbox" name="district[]" value="Santan"> Santan</label>
            <label><input type="checkbox" name="district[]" value="Azucena A"> Azucena A</label>
            <label><input type="checkbox" name="district[]" value="Azucena B"> Azucena B</label>
            <label><input type="checkbox" name="district[]" value="Rose A"> Rose A</label>
            <label><input type="checkbox" name="district[]" value="Rose B"> Rose B</label>
        </div>
    </section>
