...
$barangay = isset($_GET['barangay']) ? htmlspecialchars($_GET['barangay']) : "barangay1";
?>
<!DOCTYPE html>
<html lang="ceb">
<head>
...
<div class="container">
    ...
    <h2>Barangay 1, Nasipit, Agusan del Norte</h2>
    ...
    <section>
        ...
        <div class="checkbox-group">
            <label><input type="checkbox" name="district[]" value="Cadena De Amor"> Cadena De Amor</label>
            <label><input type="checkbox" name="district[]" value="Asci"> Asci</label>
            <label><input type="checkbox" name="district[]" value="Narra"> Narra</label>
            <label><input type="checkbox" name="district[]" value="Adelfa"> Adelfa</label>
            <label><input type="checkbox" name="district[]" value="Yarda"> Yarda</label>
        </div>
    </section>
    ...
    <section>
        ...
        <div class="checkbox-group">
            ...
            <label><input type="checkbox" name="main_district_problem[]" value="Kakuwang sa trabaho">Kakuwang sa trabaho</label>
        ...
        <div class="checkbox-group">
            ...
            <label><input type="checkbox" name="district_training_needs[]" value="Crime prevention ug disaster management para sa mga Barangay Tanod ug opisyales">Crime prevention ug disaster management para sa mga Barangay Tanod ug opisyales</label>
