...
$barangay = isset($_GET['barangay']) ? htmlspecialchars($_GET['barangay']) : "cubicubi";
?>
<!DOCTYPE html>
<html lang="ceb">
<head>
...
<div class="container">
    ...
    <h2>Barangay Cubi-Cubi, Nasipit, Agusan del Norte</h2>
    ...
    <section>
        ...
        <div class="checkbox-group">
            <label><input type="checkbox" name="district[]" value="West"> West</label>
            <label><input type="checkbox" name="district[]" value="East"> East</label>
            <label><input type="checkbox" name="district[]" value="Central I"> Central I</label>
            <label><input type="checkbox" name="district[]" value="Central II"> Central II</label>
        </div>
    </section>
