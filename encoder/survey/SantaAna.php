...
$barangay = isset($_GET['barangay']) ? htmlspecialchars($_GET['barangay']) : "santaana";
?>
<!DOCTYPE html>
<html lang="ceb">
<head>
...
<div class="container">
    ...
    <h2>Barangay Santa-Ana, Nasipit, Agusan del Norte</h2>
    ...
    <section>
        ...
        <div class="checkbox-group">
            <label><input type="checkbox" name="district[]" value="District 1-Motorpool"> District 1-Motorpool</label>
            <label><input type="checkbox" name="district[]" value="District 2-Lawis "> District 2-Lawis</label>
            <label><input type="checkbox" name="district[]" value="District 3-Refining "> District 3-Refining </label>
            <label><input type="checkbox" name="district[]" value="District 4-Cassava"> District 4-Cassava</label>
            <label><input type="checkbox" name="district[]" value="District 5-Manguibuhaton"> District 5-Manguibuhaton</label>
            <label><input type="checkbox" name="district[]" value="District 6-Saging"> District 6-Saging</label>
            <label><input type="checkbox" name="district[]" value="District 7-Lahi"> District 7-Lahi</label>
            <label><input type="checkbox" name="district[]" value="District 8-Crossing"> District 8-Crossing</label>
            <label><input type="checkbox" name="district[]" value="District 9-Tribal"> District 9-Tribal</label>
