<?php
$reportType = isset($_GET['type']) ? htmlspecialchars($_GET['type']) : "Consolidated Report";
?>
...
<head>
    ...
    <link rel="stylesheet" href="cnacrreview.css">
</head>
<body>
...
<script src="/admin/Dashboard/consolidated_result/js/get.js"></script>
