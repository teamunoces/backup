...
if (isset($_GET['mar_id']) && !empty($_GET['mar_id'])) {
    ...
    if ($pdo) {
        try {
            // Fetch header data from report_mar_header table - using correct column names
            ...
            if ($headerData) {
                // Fetch detail data from report_mar_table - using correct column names
                // Note: report_id in report_mar_table references id in report_mar_header
