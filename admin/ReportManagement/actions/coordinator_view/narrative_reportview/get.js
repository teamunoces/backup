...
function populateNarrativeForm(data) {
    ...
    if (deanElement && data.dean) {
        deanElement.textContent = data.dean;
        console.log('Set dean to:', data.dean);
    } else if (deanElement) {
        deanElement.textContent = ''; // Clear if no dean
        console.log('No dean found in data');
    }
