...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['profile_picture']) && $_FILES['profile_picture']['error'] !== UPLOAD_ERR_NO_FILE) {
        ...
        $profilePicture = "/SYSTEM_VERSION_!/admin/Profile/uploads/profile_pictures/" . $filename;

        if (!empty($currentPicture) && strpos($currentPicture, "/SYSTEM_VERSION_!/admin/Profile/uploads/profile_pictures/") === 0) {
            $oldPicturePath = __DIR__ . "/.." . str_replace("/SYSTEM_VERSION_!/admin/Profile", "", $currentPicture);
